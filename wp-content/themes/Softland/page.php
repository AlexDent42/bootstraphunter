        ...
        <div class="row">
          <div class="col-md-8 blog-content">
          	 ...
          	 <div class="row mb-5">
                ...
                <figure><img src="<?php echo get_the_post_thumbnail_url(null, 'full');?>" alt="<?php the_title();?>" class="img-fluid">
                  <figcaption><?php get_the_post_thumbnail_caption();?></figcaption>
                </figure>
